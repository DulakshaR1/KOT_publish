<%@ page title="" language="C#" masterpagefile="~/ERMSMasterPage.master" autoeventwireup="true" inherits="KOT_Request, App_Web_1f0piase" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="head">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ShowList()  
        {
            window.open("KOT_PendingList.aspx?deptid=" + $('#ContentPlaceHolder1_hfKOTDeptId').val());
        ...
        <table border="0" cellpadding="1" cellspacing="1" width="100%">
            <tr>
                <td class="head1" style="width: 200px">
                    KOT Request<asp:ScriptManager ID="ScriptManager1" runat="server">
                    </asp:ScriptManager>
                    <br />
            ...
            <tr>
                ...
                <td align="left" class="MediumBody" colspan="4" style="height: 20px" valign="top">
                    ...
                    <asp:Button id="btnPendingRequest" runat="server"
                        ...
                        Text="Pending" Width="122px" onclick="btnPendingRequest_Click"/>
                    <asp:Button id="btnConfirmRequest" runat="server"
                        BorderStyle="Solid" CausesValidation="False" CssClass="tabInactive" 
                        Text="Confirmed" Width="122px" onclick="btnConfirmRequest_Click"/>
                  ...
                  <table>
                    ...
                    <tr>
                        <td align="left" class="MediumBody" colspan="4" style="height: 24px" 
                            ...
                            <asp:Button ID="btnSendToApprove" runat="server" CssClass="btnStyle" 
                                onclick="btnSendToApprove_Click" OnClientClick="showProgress();" 
                                Text="Send To Approval" Visible="False" Width="100px" />
                           
                            <asp:Button ID="btnFinalConfirm" runat="server" CssClass="btnStyle" 
                                onclick="btnFinalConfirm_Click" OnClientClick="showProgress();" Text="Confirm" 
                                Visible="False" Width="100px" />
                           
                            <asp:Button ID="btnFinalConfirmReject" runat="server" CssClass="btnStyle" 
                                onclick="btnFinalConfirmReject_Click" OnClientClick="showProgress();" 
                                Text="Reject" Visible="False" Width="100px" />
                           
                            <asp:Button ID="btnSendToCFTApprove" runat="server" CssClass="btnStyle" 
                                onclick="btnSendToCFTApprove_Click" OnClientClick="showProgress();" 
                                Text="Send To CFT  Approval" Visible="False" Width="130px" />
                           
                            <asp:Button ID="btnCancelPendingreq" runat="server" CssClass="btnStyle" 
                                onclick="btnCancelPendingreq_Click" OnClientClick="showProgress();" 
                        ...
                        <td align="left" class="style1" valign="top">
                            ...
                            <asp:HiddenField ID="HfCurrentValue" runat="server" Value="0" />
                        </td>
                    </tr>
            <tr>
                            ...
                            <asp:DropDownList ID="ddlAMPM" runat="server" CssClass="dropDown" 
                              ...
                              <tr>
                                  ...
                                  <td align="left" class="MediumBody" style="width: 150px;" valign="top">
                                      Contact Person</td>
                                  <td align="left" class="style2" valign="top">
                                      <asp:TextBox ID="txtContPerson" runat="server" CssClass="txtBox" 
                              ...
                              <tr>
                                  ...
                                  <td align="left" class="MediumBody" style="width: 200px;">
                                      No Of Pax</td>
                                  <td align="left" class="MediumBody" style="width: 200px;" valign="top">
                                      <asp:TextBox ID="txtNoOfPax" runat="server" CssClass="txtBox" 
                                          MaxLength="20" onkeypress="return isNumberKey(event,this)" ReadOnly="True" 
                                          Width="145px">0</asp:TextBox>
                                  </td>
                                  <td align="left" class="MediumBody" style="width: 150px;" valign="top">
                                      Contact Number</td>
                                  <td align="left" class="style2" valign="top">
                                      <asp:TextBox ID="txtContNumber" runat="server" CssClass="txtBox" 
                                          MaxLength="20" ReadOnly="True" 
                                          Width="142px"></asp:TextBox>
                                  </td>
                              </tr>
                              <tr>
                                  <td align="left" style="width: 10px" valign="top">
                                      &nbsp;</td>
                                  <td align="left" class="MediumBody" style="width: 200px;">
                                      No Of TJ Represent</td>
                                  <td align="left" class="MediumBody" style="width: 200px;" valign="top">
                                      <asp:TextBox ID="txtNoOfTJRepresent" runat="server" CssClass="txtBox" 
                                          MaxLength="20" onkeypress="return isNumberKey(event,this)" ReadOnly="True" 
                                          Width="145px">0</asp:TextBox>
                                  </td>
                                  <td align="left" class="MediumBody" style="width: 150px;" valign="top">
                              ...
                              <tr>
                                  ...
                                  <td align="left" class="MediumBody" style="width: 200px;" valign="top">
                                      <asp:DropDownList ID="ddlMealType" runat="server" CssClass="dropDown" 
                                          Enabled="False" Height="20px" Width="150px" AutoPostBack="True" 
                                          onselectedindexchanged="ddlMealType_SelectedIndexChanged">
                                      </asp:DropDownList>
                                  </td>
                                  <td align="left" class="MediumBody" style="width: 150px;" valign="top">
                                                      ...
                                                      <asp:GridView ID="grdBudget" runat="server" AutoGenerateColumns="False" 
                                                          ...
                                                          <Columns>
                                                              ...
                                                              <asp:TemplateField HeaderText="Pending">
                                                                  ...
                                                                  <ItemTemplate>
                                                                      <asp:Label ID="lblPending" runat="server" Text='<%# Bind("Pending") %>' onclick = "ShowList()" ></asp:Label>
                                                                  </ItemTemplate>
                                                                  <ItemStyle HorizontalAlign="Right" />
                                                              </asp:TemplateField>
                                                              ...
                                                              <asp:TemplateField HeaderText="YearId" SortExpression="YearId" Visible="False">
                                                                  <EditItemTemplate>
                                                                      <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("YearId") %>'></asp:TextBox>
                                                                  </EditItemTemplate>
                                                                  <ItemTemplate>
                                                              ...
                                                              <asp:TemplateField HeaderText="MonthId" SortExpression="MonthId" 
                                                                  Visible="False">
                                                                  <EditItemTemplate>
                                                                      <asp:TextBox ID="TextBox6" runat="server" Text='<%# Bind("MonthId") %>'></asp:TextBox>
                                                                  </EditItemTemplate>
                                                                  <ItemTemplate>
                                          ...
                                          <tr>
                                              ...
                                              <td>
                                                  <asp:ImageButton ID="btnRefesh" runat="server" BorderColor="Silver" 
                                                      BorderWidth="1px" Enabled="False" Height="16px" ImageUrl="~/images/refresh.png" 
                                                      onclick="btnRefesh_Click" ToolTip="Refesh" Width="16px" />
                                                 </td>
                                          </tr>
                                      </table>
                                  </td>
                                              ...
                                              <td>
                                                  <table class="MediumBody">
                                                      <tr>
                                                          ...
                                                          <td>
                                                              <asp:Label ID="lblHodAppDate" runat="server" Width="90px">Approved Date</asp:Label>
                                                              &nbsp;</td>
                                                          <td>
                                                      ...
                                                      <tr>
                                                          <td>
                                                              <asp:Label ID="lblHodRemarks" runat="server" Width="80px">Remarks</asp:Label>
                                                          </td>
                                                          <td colspan="4">
                                                          ...
                                                          <tr>
                                                              ...
                                                              <td colspan="4">
                                                                  <asp:TextBox ID="txtConRejectReason" runat="server" CssClass="txtBox" 
                                                                      MaxLength="100" ReadOnly="True" Visible="False" Width="500px"></asp:TextBox>
                                                              </td>
                                                          </tr>
                                                      </table>
                                                  </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="top">
                                                                                        <asp:GridView ID="grdAllMenu" runat="server" AutoGenerateColumns="False" 
                                                                                            ...
                                                                                            onselectedindexchanged="grdAllMenu_SelectedIndexChanged1">
                                                                                            <Columns>
                                                                                                <asp:TemplateField>
                                                                                                    <EditItemTemplate>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="MenuId" SortExpression="MenuId" Visible="False">
                                                                                                    <EditItemTemplate>
                                                                                                        <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("MenuId") %>'></asp:TextBox>
                                                                                                    </EditItemTemplate>
                                                                                                    <ItemTemplate>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="MenuImage" SortExpression="MenuImage" 
                                                                                                    Visible="False">
                                                                                                    <EditItemTemplate>
                                                                                                        <asp:TextBox ID="TextBox6" runat="server" Text='<%# Bind("MenuImage") %>'></asp:TextBox>
                                                                                                    </EditItemTemplate>
                                                                                                    <ItemTemplate>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="Menu No" SortExpression="MenuNo">
                                                                                                    <EditItemTemplate>
                                                                                                        <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("MenuNo") %>'></asp:TextBox>
                                                                                                    </EditItemTemplate>
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("MenuNo") %>'></asp:Label>
                                                                                                    </ItemTemplate>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="Menu Description" SortExpression="MenuDesc">
                                                                                                    <EditItemTemplate>
                                                                                                        <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("MenuDesc") %>'></asp:TextBox>
                                                                                                    </EditItemTemplate>
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="Label3" runat="server" Text='<%# Bind("MenuDesc") %>'></asp:Label>
                                                                                                    </ItemTemplate>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="OrderBeforeId" SortExpression="OrderBeforeId" 
                                                                                                    Visible="False">
                                                                                                    <EditItemTemplate>
                                                                                                        <asp:TextBox ID="TextBox9" runat="server" Text='<%# Bind("OrderBeforeId") %>'></asp:TextBox>
                                                                                                    </EditItemTemplate>
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="lblOrdBefore" runat="server" Text='<%# Bind("OrderBeforeId") %>'></asp:Label>
                                                                                                    </ItemTemplate>
                                                                                                </asp:TemplateField>
                                                                                                <asp:TemplateField HeaderText="TimeHR" SortExpression="TimeHR" Visible="False">
                                                                                                    <EditItemTemplate>
                                                                                                        <asp:TextBox ID="TextBox10" runat="server" Text='<%# Bind("TimeHR") %>'></asp:TextBox>
                                                                                                    </EditItemTemplate>
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="lblTimeHrs" runat="server" Text='<%# Bind("TimeHR") %>'></asp:Label>
                                                                                                    </ItemTemplate>
                                                                                                </asp:TemplateField>
                                                                                                <asp:BoundField DataField="OrderBeforeId" HeaderText="Order Before (Hrs)" 
                                                                                                    SortExpression="OrderBeforeId">
                                ...
                                <tr>
                                    <td>
                                        <asp:GridView ID="grdPending" runat="server" 
                                            ...
                                            Width="800px" AllowPaging="True" onrowdatabound="grdPending_RowDataBound">
                                ...
                                <tr>
                                    <td>
                                        <asp:Panel ID="Panel4" runat="server" BorderColor="Black" BorderStyle="Solid" 
                                            BorderWidth="1px" Height="15px" Width="20px">
                                        </asp:Panel>
                                    </td>
                                    <td>
                                        Pending</td>
                                    <td>
                                        &nbsp;</td>
                                    <td>
                                        <asp:Panel ID="Panel1" runat="server" BackColor="#99FF99" BorderColor="Black" 
                                            BorderStyle="Solid" BorderWidth="1px" Height="15px" Width="20px">
                                        </asp:Panel>
                                    </td>
                                    <td>
                                        Send&nbsp; To HOD Approval</td>
                                    <td>
                                        <asp:Panel ID="Panel2" runat="server" BackColor="MistyRose" BorderColor="Black" 
                                            BorderStyle="Solid" BorderWidth="1px" Height="15px" Width="20px">
                                        </asp:Panel>
                                    </td>
                                    <td>
                                        Rejected</td>
                                    <td>
                                        <asp:Panel ID="Panel8" runat="server" BackColor="PowderBlue" 
                                            BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Height="15px" 
                                            Width="20px">
                                        </asp:Panel>
                                    </td>
                                    <td>
                                        Send For Final Approval</td>
                                </tr>
                            </table>--%>
                            <br />
                            </td>
                    ...
                    <tr>
                        <td align="left" class="MediumBody" style="height: 20px" valign="top">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <asp:GridView ID="grdConfirm" runat="server" AllowPaging="True" 
                                            AutoGenerateColumns="False" CssClass="gridView" PageSize="15" 
                                            Width="800px" onrowdatabound="grdConfirm_RowDataBound">
                                            <HeaderStyle Font-Bold="True" />
                                            <Columns>
                                                <%--  <asp:TemplateField>
                                                <EditItemTemplate>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <img src="images/viewIcon.png" Height="15px"  border="0px" id="btnEdit"  />  </a>
                                                ...
                                                <asp:TemplateField ShowHeader="False">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="LinkButton2" runat="server" CausesValidation="False" 
                                                            CommandArgument="<%# Container.DataItemIndex %>" CommandName="Select" 
                                                            ImageUrl="~/images/edit.png" onclick="LinkButton2_Click1" 
                                                            style="height: 16px" />
                                                    </ItemTemplate>
                                                    <HeaderStyle Width="10px" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Status" SortExpression="Status" Visible="False">
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="TextBox22" runat="server" Text='<%# Bind("Status") %>'></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="RequestId" SortExpression="RequestId" 
                                                    Visible="False">
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="TextBox23" runat="server" Text='<%# Bind("RequestId") %>'></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblReqId0" runat="server" Text='<%# Bind("RequestId") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="RequestNo" HeaderText="Request No" 
                                                    SortExpression="RequestNo" />
                    ...
                    <tr>
                        <td align="left" class="MediumBody" style="height: 20px" valign="top">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <asp:GridView ID="grdCancel" runat="server" AllowPaging="True" 
                                            AutoGenerateColumns="False" CssClass="gridView" PageSize="15" 
                                            Width="800px">
                                            <HeaderStyle Font-Bold="True" />
                                            <Columns>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <img src="images/viewIcon.png" Height="15px"  border="0px" id="btnEdit"  />  </a>
                                                ...
                                                <asp:TemplateField ShowHeader="False">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="LinkButton3" runat="server" CausesValidation="False" 
                                                            CommandArgument="<%# Container.DataItemIndex %>" CommandName="Select" 
                                                            ImageUrl="~/images/edit.png" style="height: 16px" />
                                                    </ItemTemplate>
                                                    <HeaderStyle Width="10px" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Status" SortExpression="Status" Visible="False">
